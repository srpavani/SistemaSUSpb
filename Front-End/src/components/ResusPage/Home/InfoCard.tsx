...
function InfoCard(props: InfoCardProps) {
  return (
    <div className="bg-roxoClaro flex flex-col justify-between items-center gap-2 p-3 rounded-lg w-[48.5%] transition-all xl:min-w-40 xl:px-2 xl:py-6 2xl:max-w-56 hover:bg-[#dddae2]">
      <div
        className="rounded-full mb-2 "
        style={{ border: `14px solid ${props.color}` }}
      >
        <Image
