...
function InfoCard(props: InfoCardProps) {
  return (
    <div className="bg-roxoClaro flex flex-col justify-between items-center gap-2 p-3 rounded-lg w-48% transition-all xl:min-w-40 2xl:max-w-60 xl:px-2 xl:py-6  hover:bg-[#d4d1d8]">
