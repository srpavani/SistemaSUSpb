...
function GraphicCard({ textColor, title, quantity }: GraphicCard) {
  return (
     <div className="bg-white rounded-2xl text-center py-4 px-8 text-roxo flex flex-col justify-between items-center w-48% transition hover:bg-[#ffffff94] xl:w-60">
