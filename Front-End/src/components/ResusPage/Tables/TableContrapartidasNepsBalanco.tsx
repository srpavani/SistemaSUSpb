...
function TableContrapartidasNepsBalanco() {
  ...
  return (
    <>
      <Table className="mt-14 mb-16 font-bold border-roxo border-2">
        <TableHeader className="bg-roxo">
          <TableRow className="text-white hover:bg-violet-950">
            <TableHead className="text-white text-center text-lg">Clique na NEP para gerar um balanço</TableHead>
          </TableRow>
        </TableHeader>
      ...
      {modalOpen && (
        <ModalNEP isOpen={modalOpen} id={id} onClose={() => setModalOpen(false)} />
      )}
    </>
  )
}

export default TableContrapartidasNepsBalanco