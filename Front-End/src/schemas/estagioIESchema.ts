...
export const estagioIESchema = z.object({
  nome_estudante: z.string().min(6, "O nome deve ter pelo menos 5 caracteres"),
  ...
  nome_seguradora: z.string().min(1, "Insira o nome da seguradora"),
  numero_apolice: z
    .string()
    .min(1, "Insira o número da apólice")
    .regex(/^[A-Za-z0-9]+$/, "Insira um número de apólice válido"),
});

export type EstagioIESchemaType = z.infer<typeof estagioIESchema>;
