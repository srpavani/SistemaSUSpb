...
export default function TableIEsConveniadas() {
      ...
      <Table className="mt-4 mb-12 font-bold border-[#3C117E] border-2">
        <TableHeader className="bg-violet-900">
          <TableRow className="text-white hover:bg-violet-950">
            <TableHead className="text-white text-center text-lg">Nome</TableHead>
            <TableHead className="text-white text-center text-lg">Tipo da IE</TableHead>
            <TableHead className="text-white text-center text-lg">Estagiários</TableHead>
          </TableRow>
        </TableHeader>

        <TableBody className="text-center text-sm2">
          {filteredData.map((item, index) => ( 
            <TableRow key={item.instituicaoEnsino} className={`${index % 2 === 0 ? 'bg-[#E6E1EE] hover:bg-[#eceaea]' : 'bg-white hover:bg-[#eceaea]'}`}>
              ...
              <TableCell className="border-[#3C117E] border-r-2 py-1 w-1/4">{item.tipoIE}</TableCell>
