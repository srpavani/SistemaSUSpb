...
export function FormCadastroNEP1Etap({ register, errors }: Props) {
  return (
...
export function FormCadastroNEP2Etap({ register, errors }: Props) {
  return (
    <div className="flex flex-col gap-6">
      <Input
...
export function FormCadastroNEP3Etap({ register, errors }: Props) {
  return (
    <div className="flex flex-col gap-6">
      <Input
