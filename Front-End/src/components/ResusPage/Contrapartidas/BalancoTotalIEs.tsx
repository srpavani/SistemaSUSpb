...
import TableContrapartidasBalancoTotalIEs from "../Tables/TableContrapartidasBalancoTotalIEs";

interface Props {
  searchParams: { view: string, date: string };
}

export default function BalancoTotalIEs({ searchParams }: Props) {
  ...
  return (
    <>
      ...
      <TableContrapartidasBalancoTotalIEs date={searchParams.date} view={searchParams.view}  />
    </>
  )
}